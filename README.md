...
$$b_4=b_1+b_2+b_3\pm 2\sqrt{b_1b_2+b_1b_3+b_2b_3}$$<br/>
3. If the two bends are the same (i.e. the discriminant was 0), use the quadratic formula on the complex Descartes' theorem to find the two different circle centers matching that same bend, where $u_i=z_ib_i$, with $z_i$ being the complex number corresponding to the circle center:<br/>
