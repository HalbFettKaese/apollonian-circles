...
export function* findTangentCircles([z1, r1], [z2, r2], [z3, r3]) {
    var k1 = 1 / r1;
    var k2 = 1 / r2;
    var k3 = 1 / r3;
    for (var i = 0; i < 2; i++) {
...
export function findTangentCircle([z1, r1], [z2, r2], [z3, r3], [z4, r4]) {
    var k1 = 1 / r1;
    var k2 = 1 / r2;
    var k3 = 1 / r3;
    var k4 = 1 / r4;
...
export function drawApollonian(canvas, ctx, init_circles) {
    ctx.fillStyle = "white";
    ctx.clearRect(0, 0, canvas.width, canvas.height);
    var minDim = Math.min(canvas.width, canvas.height) - 10;
    function draw_circle([z, r_old]) {
    ...
    var circle_queue = new SortedList(([[z1, r1]], [[z2, r2]]) => Math.abs(r2) - Math.abs(r1));
    function add_circle(c, parents, i) {
